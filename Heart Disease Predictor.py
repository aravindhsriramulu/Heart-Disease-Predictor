...
def predict_heart_disease(age, sex, chest_pain, blood_pressure, cholesterol, fasting_blood_sugar, rest_ecg, max_heart_rate, induced_angina, st_depression, slope, vessels, thal):
    input_data = np.array([[age, sex, chest_pain, blood_pressure, cholesterol, fasting_blood_sugar, rest_ecg, max_heart_rate, induced_angina, st_depression, slope, vessels, thal]])
